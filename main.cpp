...
int main() {
	...
	while (true) {
		...
		cout << "1- Listar servi�os" << endl;
		cout << "2- Ver senhas" << endl;
		cout << "3- Pesquisar por servi�o" << endl;
		cout << "4- Adicionar novo servi�o" << endl;
		cout << "5- Sair" << endl;
		...
		case 3: {
			cout << "Qual servi�o voc� deseja encontrar? ";
			string servico;
			cin >> servico;
			bool achou = false;
			...
			if (!achou) {
				cout << "N�o encontramos este servi�o em nosso banco" << endl;
			}
			continuar();
			break;
		}
